    ...
    public class Program
    {
        ...
        public class DoubleLinkedList
        {
            ...
            static void Main()
            {
                ...
                list.Insert("11", "19");
                list.Print();
                Console.WriteLine("Max Node: " + list.FindMax().element.ToString());*/
                ...
                dlist.Print();
                Console.WriteLine("Max of DoubleLinkedList: " + dlist.FindMaxdlist().element.ToString());
